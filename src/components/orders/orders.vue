      ...
      <el-dialog
        ...
        <span class="dialog-footer" slot="footer">
          ...
          <!-- <span v-if="deviceViewData.device.pkey==='host' && filter === '已审核'">
            <router-link :to="{ path: `/guosen-info/${deviceViewData.device.pkey}/${deviceViewData.device.taskDefinitionKey}/${deviceViewData.device.id}/${deviceViewData.device.name}`}" class="el-button el-button--plain">查看</router-link>
          </span>
